...
class ApplicationClassificationTestCase(TestCaseInterface):

    def __init__(self):
        super().__init__()
        self._logger = logging.getLogger('ApplicationCla')
    ...
    def runTest(self, signatureMethod, errorMethods=None):
        self._logger.info('Application classification test case')
