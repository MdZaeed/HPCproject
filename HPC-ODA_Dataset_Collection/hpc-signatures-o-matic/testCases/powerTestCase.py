...
class PowerPredictionTestCase(TestCaseInterface):

    def __init__(self):
        super().__init__()
        self._logger = logging.getLogger('PowerPredictio')
        self.sensorsPath = "./datasets/power_prediction/sensors"
        self.responsesPath = "./datasets/power_prediction/responses"
        self.window = 10
        self.step = 5
        self.tests = 5
    ...
    def runTest(self, signatureMethod, errorMethods=None):
        self._logger.info('Power prediction test case')
